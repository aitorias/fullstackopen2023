...
if (!global.jake) {
  ...
  let fs = require('fs');
  let chalk = require('jake/node_modules/chalk');
  let taskNs = require('jake/lib/task');
  let Task = taskNs.Task;
  let FileTask = taskNs.FileTask;
  let DirectoryTask = taskNs.DirectoryTask;
  let Rule = require('jake/lib/rule').Rule;
  let Namespace = require('jake/lib/namespace').Namespace;
  let RootNamespace = require('jake/lib/namespace').RootNamespace;
  let api = require('jake/lib/api');
  let utils = require('jake/lib/utils');
  let Program = require('jake/lib/program').Program;
  let loader = require('jake/lib/loader')();
  ...
  Object.assign(jake, new (function () {
    ...
    this.PackageTask = require('jake/lib/package_task').PackageTask;
    this.PublishTask = require('jake/lib/publish_task').PublishTask;
    this.TestTask = require('jake/lib/test_task').TestTask;
    this.Task = Task;
